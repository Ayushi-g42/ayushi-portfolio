  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <div className="orb w-[600px] h-[600px] -top-40 -left-40 bg-accent-500/10" style={{ animationDelay: '0s' }} />
        <div className="orb w-[400px] h-[400px] top-1/2 -right-20 bg-violet-500/8" style={{ animationDelay: '3s' }} />
        <div className="orb w-[300px] h-[300px] bottom-20 left-1/3 bg-accent-500/5" style={{ animationDelay: '5s' }} />
      ...
      <div className="container relative z-10 pt-24 pb-16">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent-500/20 bg-accent-500/5 text-sm text-accent-400 font-medium">
          ...
          {/* Greeting */}
          <motion.p variants={itemVariants} className="text-text-muted text-lg mb-3 font-medium">
            Hi, I&apos;m
          </motion.p>
          ...
          >
            ...
            <br />
            <span className="text-white">Gothi</span>
          </motion.h1>
          ...
          <motion.div variants={itemVariants} className="flex items-center gap-3 mb-16">
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-11 h-11 rounded-2xl border border-dark-border glass flex items-center justify-center text-text-muted hover:text-accent-400 hover:border-accent-500/40 transition-all"
              >
                {s.icon}
              </motion.a>
            ))}
        ...
        <motion.button
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-text-subtle hover:text-accent-400 transition-colors"
